...
- [x] 13.1.1 Создать `ReportsViewModel.kt`
- [x] 13.1.2 Статистика по животным
- [x] 13.1.3 Статистика по задачам
- [x] 13.1.4 Статистика по запасам
- [x] 13.1.5 Финансовая статистика (продажи товаров)

#### 13.2 Экран

- [x] 13.2.1 `ReportsScreen.kt`
  - [x] Карточки сводки
  - [x] Простые графики (опционально)
  - [x] Экспорт в текст (опционально)

#### 13.3 Компоненты

- [x] 13.3.1 `ReportStatCard.kt`
- [x] 13.3.2 `SimpleChart.kt` (опционально)

#### 13.4 Интеграция

- [x] 13.4.1 Подключить навигацию
- [x] 13.4.2 Протестировать функционал
...
- [x] 14.1 Интегрировать все модули в единую навигацию
- [x] 14.2 Обновить главный экран (Dashboard) с реальными данными
- [ ] 14.3 Реализовать глобальный поиск (опционально)
- [x] 14.4 Добавить настройки приложения
  - [x] Тема (светлая/тёмная)
  - [ ] Уведомления
  - [ ] Резервное копирование БД (опционально)
- [x] 14.5 Оптимизировать производительность
  - [x] LazyColumn pagination (если нужно) - базовое использование Flow/Room обеспечивает хорошую производительность
- [x] 14.6 Проверить все переходы и навигацию
- [x] 14.7 Проверить обработку ошибок
- [x] 14.8 Провести код-ревью всех модулей
...
- [x] 15.1.1 Тесты для всех Repository
- [x] 15.1.2 Тесты для всех ViewModel
- [x] 15.1.3 Тесты для DAO

#### 15.2 UI тесты ✅

- [x] 15.2.1 Тесты навигации
- [x] 15.2.2 Тесты основных экранов
- [x] 15.2.3 Тесты CRUD операций
...
- [x] 16.1 Написать README.md
- [x] 16.2 Добавить KDoc комментарии к основным классам
- [x] 16.3 Создать CHANGELOG.md
- [x] 16.4 Создать инструкцию по сборке
...
- [x] 17.1 Создать иконку приложения
- [x] 17.2 Создать splash screen (опционально)
- [x] 17.3 Настроить ProGuard/R8 для release
- [x] 17.4 Настроить подпись APK
- [x] 17.5 Собрать release APK
- [x] 17.6 Провести финальное тестирование release сборки
- [x] 17.7 Создать release в Git с тегом версии v1.0.0
- [x] 17.8 (Опционально) Подготовить к публикации в Google Play
