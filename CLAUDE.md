...
- [ ] 0.1 Проверить шаблон Empty Activity в папке проекте.
- [ ] 0.2 Скачать и установить агентов из VoltAgent в `.claude/agents/`
- [ ] 0.3 Открыть шаблон Empty Activity.
- [ ] 0.4 Инициализировать Git репозиторий
- [ ] 0.5 Создать `.gitignore` файл
- [ ] 0.6 Создать базовую структуру папок по шаблону
